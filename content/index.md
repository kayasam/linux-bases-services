...
<section class="network-hero">
  ...
  <div class="network-hero__visual">
    <img src="./Ressources/images/architecture-laboratoire.svg" alt="Architecture du laboratoire Linux avec DNS, Web, messagerie, pare-feu et stockage">
    <span class="network-status"><i aria-hidden="true"></i> Laboratoire documenté</span>
  </div>
</section>
