...
Écrire une phrase testable : « depuis le client `192.168.56.10`, le nom `www.dawan.test` se résout mais la connexion TCP au port 80 échoue ». Éviter « Internet ne marche pas », trop vague pour orienter une recherche.
